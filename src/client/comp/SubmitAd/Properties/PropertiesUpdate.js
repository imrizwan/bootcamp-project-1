...
class PropertiesUpdate extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            category: this.props.ads ? this.props.ads.category : this.props.category,
            type: this.props.ads ? this.props.ads.type : '',
            description: this.props.ads ? this.props.ads.description : '',
            price: this.props.ads ? this.props.ads.price : '',
            bedrooms: this.props.ads ? this.props.ads.bedrooms : '',
            bathrooms: this.props.ads ? this.props.ads.bathrooms : '',
            furnishing: this.props.ads ? this.props.ads.furnishing : '',
            constructionstatus: this.props.ads ? this.props.ads.constructionstatus : '',
            listedby: this.props.ads ? this.props.ads.listedby : '',
            SBArea: this.props.ads ? this.props.ads.SBArea : '',
            carpetArea: this.props.ads ? this.props.ads.carpetArea : '',
            bachelorsallowed: this.props.ads ? this.props.ads.bachelorsallowed : '',
            maintenance: this.props.ads ? this.props.ads.maintenance : '',
            totalFloors: this.props.ads ? this.props.ads.totalFloors : '',
            floorNumber: this.props.ads ? this.props.ads.floorNumber : '',
            carparking: this.props.ads ? this.props.ads.carparking : '',
            facing: this.props.ads ? this.props.ads.facing : '',
            projectname: this.props.ads ? this.props.ads.projectname : '',
            location: this.props.ads ? this.props.ads.location : '',
            name: this.props.ads ? this.props.ads.name : '',
            phone: this.props.ads ? this.props.ads.location : '',
            file: []
        }
    }
